...
object Lorem {
    ...
    private val minWords = 1
    private val maxWords = 16
    private val minSentences = 1
    private val maxSentences = 16
    private val minParagraps = 1
    private val maxParagraps = 16
    ...
    fun paragraphs(paragraphs: Int): String {
        ...
        return compose({ paragraph() }, count, Separator.NEWLINE.str, Separator.NONE.str)
    }
